...
#	define BCA_BCDA(bca) ((bca).arrayOfBaseClassDescriptors)	//!!!P
...
#if _RTTI_RELATIVE_TYPEINFO
//!!!?#	define CHD_PBCD(chd)               (((_RTTIClassHierarchyDescriptor*)((&(chd))[1].pTypeDescriptor))->pBaseClassArray->arrayOfBaseClassDescriptors[0])	//!!!P
