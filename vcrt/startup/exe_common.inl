...
// PGO is initialized, but defer some initialization steps to after.  See the
// commentary in post_pgo_initialization for details.
_CRTALLOC(".CRT$XIAA") _PIFV CRT_CONCAT_FILE(pre_c_initializer, CRT_PFX)    = pre_c_initialization;
_CRTALLOC(".CRT$XIAC") _PIFV CRT_CONCAT_FILE(post_pgo_initializer, CRT_PFX) = post_pgo_initialization;
_CRTALLOC(".CRT$XCAA") _PVFV CRT_CONCAT_FILE(pre_cpp_initializer, CRT_PFX)  = pre_cpp_initialization;
