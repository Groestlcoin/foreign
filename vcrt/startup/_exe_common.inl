...
#define CRT_CONCAT1(a, b) a##b						///!!!P
#define CRT_CONCAT_FILE(a, b) CRT_CONCAT1(a, b)
...
_CRTALLOC(".CRT$XIAA") /*!!!P static*/ _PIFV CRT_CONCAT_FILE(pre_c_initializer, CRT_PFX)    = pre_c_initialization;
_CRTALLOC(".CRT$XIAC") /*!!!P static*/ _PIFV CRT_CONCAT_FILE(post_pgo_initializer, CRT_PFX) = post_pgo_initialization;
_CRTALLOC(".CRT$XCAA") /*!!!P static*/ _PVFV CRT_CONCAT_FILE(pre_cpp_initializer, CRT_PFX)  = pre_cpp_initialization;
