...
//!!!R #define _free_crt                       free
#define _msize_crt                      _msize
//!!!R #define _dupenv_s_crt(ps1, size, s2)    _dupenv_s(ps1, size, s2)
//!!!R #define _wdupenv_s_crt(ps1, size, s2)   _wdupenv_s(ps1, size, s2)
