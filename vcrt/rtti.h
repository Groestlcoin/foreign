...
extern "C" _RTTITypeDescriptor * __cdecl __RTtypeid (PVOID *) noexcept(false);          // ptr to src object


extern "C" PVOID __cdecl __RTCastToVoid (PVOID *) noexcept(false);                                      // ptr to src object
...
extern "C" PVOID __cdecl __RTDynamicCast (
                                                                ...
                                                                PVOID,                          // src type
                                                                PVOID,                          // target type
                                                                BOOL) noexcept(false);                          // isReference

extern "C" PVOID __cdecl __RTtypeid (PVOID) noexcept(false);            // ptr to vfptr

extern "C" PVOID __cdecl __RTCastToVoid (PVOID) noexcept(false);        // ptr to vfptr
