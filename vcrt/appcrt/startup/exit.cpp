...
// This function never returns.  It causes the process to exit, normally if
// possible, abnormally otherwise.
static void __cdecl exit_process(UINT const return_code) throw()
{
...
{
    return static_cast<int>(_InterlockedCompareExchange(&c_termination_complete, FALSE, FALSE));
}
