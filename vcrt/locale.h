...
// CRT_REFACTOR TODO These are used by the C++ Standard Library code.  We either
// need to replace them with existing public functionality, or add new public
// functionality to the CRT.
