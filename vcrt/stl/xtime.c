...
_ACRTIMP void WINAPI __acrt_GetSystemTimePreciseAsFileTime(
	_Out_ LPFILETIME lpSystemTimeAsFileTime
);	//!!!P

_ACRTIMP void __cdecl __crtGetSystemTimePreciseAsFileTime(
	_Out_ LPFILETIME lpSystemTimeAsFileTime
) {
	__acrt_GetSystemTimePreciseAsFileTime(lpSystemTimeAsFileTime);
}
