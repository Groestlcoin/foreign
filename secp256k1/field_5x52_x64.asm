...
secp256k1_fe_mul_inner PROC PUBLIC USES RBX RDI RSI R12 R13 R14 R15 ;, r:QWORD, a:QWORD, b:QWORD
	push	rbp
IFDEF __JWASM__
	push	rdi								; r
	mov	rdi, rsi						; a
...
secp256k1_fe_sqr_inner PROC PUBLIC USES RBX RDI RSI R12 R13 R14 R15 ;, r:QWORD, a:QWORD
	push	rbp
IFDEF __JWASM__
	push	rdi							; r
	mov	rdi, rsi					; a
