...
namespace std {
  ...
  public:
    ...
    static mpz_class (min)() { return mpz_class(); }	//!!!P
    static mpz_class (max)() { return mpz_class(); }	//!!!P
  ...
  public:
    static const bool is_specialized = true;
    static mpq_class (min)() { return mpq_class(); }		//!!!P
    static mpq_class (max)() { return mpq_class(); }		//!!!P
  ...
  public:
    static const bool is_specialized = true;
    static mpf_class (min)() { return mpf_class(); }		//!!!P
    static mpf_class (max)() { return mpf_class(); }		//!!!P
